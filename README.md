...
> 저장소에 스크린샷을 추가하려면 아래 이미지를 캡처해 `docs/images/`에 넣어 주세요.

| 파일 | 설명 |
|------|------|
| `main-list.png` | 메인 화면 — 종류별 그룹, 점유율 막대, 미리보기 패널 |
| `delete-pending.png` | 삭제 예정 탭 |
| `backup-pending.png` | 백업 예정 탭 (백업 경로 + 종류별 폴더 옵션) |

예시 (추가 후 README에 아래 주석 해제):

<!--
![FolderTidy main screen](docs/images/main-list.png)
-->
